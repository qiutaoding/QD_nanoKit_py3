...
library("ggplot2")
library("seqinr")
df=read.table("plot/zzy0603_45s.csv",header=FALSE)
blast_title<-c("query","subject","ldentity","length","mismatch","gap","qstart","qend","sstart","send","evalue","bitscore")
colnames(df)<-blast_title
fa<-read.fasta(file="extracted_read/zzy0603_45s_read.fa")
readlist <-read.table("extracted_read/zzy0603_45s_list")

readName = "bbbe06ab-7145-476f-b0fd-fec95da2d640"
